...
from utils.Discriminator import DiscriminatorDCGAN
...
parser.add_argument('-d',
                    '--dataset',
                    help='select dataset: mnist, cifar10, stl10',
                    type=str,
                    default='mnist')
parser.add_argument('-gt',
                    '--gantype',
                    help='select gan type: gcgan, gan',
                    type=str,
                    default='gcgan')
...
if GAN_TYPE == 'gan':
    netD = DiscriminatorGAN(64 * 64 * CHANNEL_SIZE, 1, args.batch)
...
# Generally SGD worked better as the Discriminator's optimizer
optimizerD = optim.SGD(netD.parameters(), lr=0.0002)
